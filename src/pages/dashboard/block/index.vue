  ...
  data() {
    return {
      columns: [
        ...
        {
          title: "sphinx_table_name",
          key: "sphinx_table_name",
          minWidth: 100
        },
        {
          title: "sphinx_table_name2",
          key: "sphinx_table_name2",
          minWidth: 120
        },
        {
          title: "sphinx_area",
      ...
      dataList: [
        {
          ...
          url: 300,
          query: 1,
          sphinx_query: "202.118.118.1",
          sphinx_table_name: "202.118.118.2",
          sphinx_table_name2: 11,
          sphinx_area: 1,
          sphinx_cate: 1,
          sphinx_calssaid: 1,
          is_show_description: 1,
          is_show_total: 1,
          rp: 2
        }
      ],
